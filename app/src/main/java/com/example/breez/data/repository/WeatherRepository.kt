...
interface WeatherRepository {
    suspend fun getCurrentWeather(lat: Double, lon: Double): ApiResult<CurrentWeatherDto>
    suspend fun getForecast(lat: Double, lon: Double): ApiResult<ForecastResponseDto>

    suspend fun getCoordinatesFromCityName(cityName: String): ApiResult<List<GeocodingDto>>

    suspend fun getLocationNameFromCoordinates(lat: Double, lon: Double): ApiResult<List<GeocodingDto>>
}